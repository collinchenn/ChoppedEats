...
export default function LoadingEnhanced() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-r from-red-200 via-orange-200 via-yellow-200 to-yellow-50">
      <div className="bg-white rounded-3xl shadow-2xl p-12 max-w-md w-full mx-4">
        <div className="flex flex-col items-center gap-6">
          ...
          <div className="text-center">
            <h3 className="text-2xl font-bold text-gray-900 mb-2">Getting Ready...</h3>
            <p className="text-gray-600">Setting up your group dining experience</p>
          </div>
          ...
          <div className="text-sm text-gray-500 text-center animate-pulse">
            Finding the perfect spot for your crew...
          </div>
        </div>
      </div>
    </div>
